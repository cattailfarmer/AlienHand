...
def run_app_thelounge_refinement_workbench_proof(
    ...
    *,
    ...
    workbench_bundle_markers = {
        ...
        "keyboard raw tracking shortcut": "Ctrl+Alt+T raw tracking",
        "keyboard raw tracking status": "Ctrl+Alt+T toggled raw text tracking.",
        ...
        "raw tracking action": "Track raw text",
        "raw tracking stop action": "Stop tracking raw text",
        "raw tracking status": "Raw text tracking is on.",
        ...
        "quote action": "Quote",
        "quote source action": "Use source as quote",
        "quote summary action": "Use summary as quote",
        "quote provenance label": "Quote source:",
        "quote draft status": "Quote draft filled from",
    ...
    workbench_style_markers = {
        ...
        "quote provenance footer": "alienhand-workbench__quotes footer",
